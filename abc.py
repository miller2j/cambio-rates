...
def get_fx_rates(code,url,current_date,currencies):
    ''' Get list of FX Rates from ABC Bank, by parsing scraped content.
    Parameters:
    ...
    Processing:
            Writes currency values to respective date currency file, e.g. '2020-03-25_ABC.json'
    ...
    table = soup.select_one('.abc--table').tbody
    ttmp = []
